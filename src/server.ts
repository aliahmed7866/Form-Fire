  ...
  const handle=async(req:IncomingMessage,res:ServerResponse)=>{
    ...
    try {
      ...
      if(!p.startsWith('/api/')) {
        ...
        const files:Record<string,[string,string]>={'/exercise-catalog.js':['exercise-catalog.js','text/javascript'],'/exercise-catalog-extra.js':['exercise-catalog-extra.js','text/javascript'],'/exercise-motion.js':['exercise-motion.js','text/javascript'],'/exercise-motion.css':['exercise-motion.css','text/css'],'/experience.js':['experience.js','text/javascript'],'/lifestyle-art.js':['lifestyle-art.js','text/javascript'],'/google-mark.svg':['google-mark.svg','image/svg+xml'],'/art-outdoors.svg':['art-outdoors.svg','image/svg+xml'],'/art-rest.svg':['art-rest.svg','image/svg+xml'],'/art-kitchen.svg':['art-kitchen.svg','image/svg+xml'],'/art-stretch.svg':['art-stretch.svg','image/svg+xml'],'/brand-mark.svg':['brand-mark.svg','image/svg+xml'],'/art-training.svg':['art-training.svg','image/svg+xml'],'/art-nourish.svg':['art-nourish.svg','image/svg+xml'],'/art-dining.svg':['art-dining.svg','image/svg+xml'],'/art-rhythm.svg':['art-rhythm.svg','image/svg+xml'],'/enrichment.js':['enrichment.js','text/javascript'],'/daily-plan.js':['daily-plan.js','text/javascript'],'/plan-studio.js':['plan-studio.js','text/javascript'],'/app.js':['app.js','text/javascript'],'/style.css':['style.css','text/css'],'/hero.svg':['hero.svg','image/svg+xml']};
