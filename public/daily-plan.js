...
async function todayPage(d) {
  ...
  return header+controls+requestsNote+sections+shopping+`<section class="weekly-history"><div class="section-top"><div><div class="eyebrow">${monday} to ${sunday}</div><h2>A few steps <span class="serif">worth noticing.</span></h2></div></div><p class="micro">Only what you choose to log. A blank day isn’t a judgement.</p>${activityHistory(d,entries)}</section>`;
}
